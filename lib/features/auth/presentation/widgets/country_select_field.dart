...
import 'package:instant_grrocery_delivery/core/utils/countries.dart';
...
class CountrySelectField extends StatefulWidget {
  const CountrySelectField({super.key});
...
class SearchBoxDelegate extends SliverPersistentHeaderDelegate {
  ...
  SearchBoxDelegate({required this.onChanged});
  @override
  Widget build(
  ...
  @override
  double get maxExtent => 40; // Set the maximum extent (height) of the search box

  @override
  double get minExtent => 40; // Set the minimum extent (height) of the search box
