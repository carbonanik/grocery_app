...
@freezed
class OrderReadDto with _$OrderReadDto {
  const factory OrderReadDto({
    required int id,
    required OrderSubReadDto attributes,
  }) = _OrderReadDto;

  factory OrderReadDto.fromJson(Map<String, dynamic> source) => _$OrderReadDtoFromJson(source);
}
...
@freezed
class OrderSubReadDto with _$OrderSubReadDto {
  ...
  factory OrderSubReadDto.fromJson(Map<String, dynamic> source) => _$OrderSubReadDtoFromJson(source);
}

@freezed
class OrderItemReadDto with _$OrderItemReadDto {
  const factory OrderItemReadDto({
    required int count,
    required ProductDto product,
  }) = _OrderItemReadDto;

  factory OrderItemReadDto.fromJson(Map<String, dynamic> source) => _$OrderItemReadDtoFromJson(source);
}
...
@freezed
class UserInOrderReadDto with _$UserInOrderReadDto {
  const factory UserInOrderReadDto({
    required UserReadDto data,
  }) = _UserInOrderReadDto;

  factory UserInOrderReadDto.fromJson(Map<String, dynamic> source) => _$UserInOrderReadDtoFromJson(source);
}
...
class UserReadDto with _$UserReadDto {
  ...
  factory UserReadDto.fromJson(Map<String, dynamic> source) => _$UserReadDtoFromJson(source);
}

@freezed
class UserSubReadDto with _$UserSubReadDto {
  ...
  factory UserSubReadDto.fromJson(Map<String, dynamic> source) => _$UserSubReadDtoFromJson(source);
}
