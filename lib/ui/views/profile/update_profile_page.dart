      ...
      body: SafeArea(
        child: Consumer(builder: (context, ref, child) {
          ...
          return updateUserState.map(
            empty: (value) => const Center(child: CircularProgressIndicator()),
                      ...
                      AuthButton(
                        onPressed: updateUserState.isLoading
                            ...
                            : () {
                                ...
                                ref.read(authControllerProvider.notifier).update(updateUser);
                                // ref.(updateUserControllerProvider.notifier);
                              },
                        text: updateUserState.isLoading ? 'Please Wait' : 'Update',
                      ),
